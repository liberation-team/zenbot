...
module.exports = {
  ...
  getOptions: function () {
    this.option('period', 'period length, same as --period_length', String, '33m')
    this.option('period_length', 'period length, same as --period', String, '33m')
    this.option('min_periods', 'min. number of history periods', Number, 17)
    this.option('trend_ema', 'number of periods for trend EMA', Number, 10)
    ...
    this.option('oversold_rsi_periods', 'number of periods for oversold RSI', Number, 28)
    this.option('oversold_rsi', 'buy when RSI reaches this value', Number, 43)
  },
  ...
  phenotypes: {
    ...
    markdown_buy_pct: Phenotypes.RangeFloat(-2, 7),
    markup_sell_pct: Phenotypes.RangeFloat(-2, 7),
    order_type: Phenotypes.ListOption(['maker', 'taker']),
    sell_stop_pct: Phenotypes.Range0(1, 60),
    buy_stop_pct: Phenotypes.Range0(1, 60),
    profit_stop_enable_pct: Phenotypes.Range0(1, 30),
    profit_stop_pct: Phenotypes.Range(1,30),

    // -- strategy
    trend_ema: Phenotypes.Range(1, 50),
    oversold_rsi_periods: Phenotypes.Range(3, 60),
    oversold_rsi: Phenotypes.Range(10, 110)
  },
}
